        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastName = table.Column<string>(type: "TEXT", nullable: false),
                    Dob = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    DrivingLicenseNo = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationLng = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TravelTimeNextLocale = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItineraryLocations", x => new { x.ItineraryId, x.LocationId });
                    table.ForeignKey(
                        name: "FK_ItineraryLocations_Itineraries_ItineraryId",
                        column: x => x.ItineraryId,
                        principalTable: "Itineraries",
                        principalColumn: "ItineraryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItineraryLocations_Locations_LocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItineraryLocations_LocationId",
